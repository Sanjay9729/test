...
const ViewWarranty = () => {
 ...
 const rowMarkup = filtered.map((item, index) => (
  ...
  >
    <IndexTable.Cell>
      <Text variant="bodyMd" as="span">{item.full_name || '-'}</Text>
    </IndexTable.Cell>

    <IndexTable.Cell>
      <Box style={{ whiteSpace: 'normal', wordBreak: 'break-word' }}>
        <Text variant="bodyMd" as="span">{item.email || '-'}</Text>
      </Box>
    </IndexTable.Cell>

    <IndexTable.Cell>
      <Text variant="bodyMd" as="span">{item.phone || '-'}</Text>
    </IndexTable.Cell>
  ...
  >
    <Text variant="bodyMd" as="span">{item.address || '-'}</Text>
  </Box>
    </IndexTable.Cell>

    <IndexTable.Cell>
      <Text variant="bodyMd" as="span">{item.product_sku || '-'}</Text>
    </IndexTable.Cell>
    ...
    <IndexTable.Cell>
      <Box style={{ whiteSpace: 'normal', wordBreak: 'break-word' }}>
        <Text variant="bodyMd" as="span">{item.selected_product || '-'}</Text>
      </Box>
    </IndexTable.Cell>
  </IndexTable.Row>
));
  ...
  { title: 'Email' },
  { title: 'Phone' },
  { title: 'Address' },  // 🔄 Swapped position
  { title: 'SKU' },
  { title: 'Image' },
  { title: 'Product' },  // 🔄 Swapped position
]}
